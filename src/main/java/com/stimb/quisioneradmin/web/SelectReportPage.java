 ...
 */
@MountPath("report")
public class SelectReportPage extends PubLayout {
    ...
    public SelectReportPage(PageParameters parameters) {
        super(parameters);
            ...
            protected void populateItem(Item<ReleaseKrs> item) {
                ...
                item.add(new Link<Void>("cetak"){
                    ...
                    public void onClick() {
                        ...
                        String filename = "PER_"+rks.getKodeMataKuliah()+"_"+rks.getNamaMataKuliah()+"_"+rks.getNamaDosenRaw()+"_"+rks.getIdKrs();
                        ReportGenerator reportGenerator = new ReportGenerator();
                        reportGenerator.PrintPDFSelectedReport(rks.getIdKrs(),filename);
        ...
        form.add(new LaddaAjaxButton("klik", new Model<String>("Cari"), Buttons.Type.Default) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                releaseKrses.clear();
                num = 0;
                List<KartuRencanaStudi> krs = kartuRencanaStudiRepository.findByNamaKuliah(matakuliahsearch.getModelObject());
